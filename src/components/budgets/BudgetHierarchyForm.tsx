      ...
      items.forEach((item) => {
        if (
          ...
          if (quantity > 0) {
            ...
            const ivaAmount =
              itemTotal * (ivaPercentage / (100 + ivaPercentage));
            ...
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                onBlur={(e) => {
                  ...
                  const formattedValue = formatSpanishNumber(
      ...
      <div className="w-full max-w-md ml-auto space-y-0.5">
        ...
        {totals.ivaGroups.map((group) => (
          ...
          >
            <span style={{ marginLeft: "12px" }}>
              {formatSpanishNumber(group.percentage, 2)}% IVA
            </span>
        ...
        {irpf > 0 && (
          ...
          >
            <div className="flex items-center gap-2">
              <span style={{ marginLeft: "12px" }}>
                {formatSpanishNumber(irpfPercentage, 2)}% IRPF
              </span>
              <Dialog>
                <DialogTrigger asChild>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ...
                      se aplica automáticamente cuando el emisor es autónomo y
                      el cliente es empresa o autónomo. Este importe se retiene
                      del total a pagar.
                    </DialogDescription>
                  </DialogHeader>
                </DialogContent>
        ...
        {totalRE > 0 && Object.keys(reByIVA).length > 0 && (
          <>
            {Object.entries(reByIVA).map(([iva, amount]) => {
              ...
              // Calcular porcentaje de RE: necesitamos baseIVA
              const ivaGroup = totals.ivaGroups.find(
                (g) => g.percentage === ivaNum
              );
              const ivaAmount = ivaGroup?.amount || 0;
              const baseIVA = ivaAmount / (ivaNum / 100);
              ...
              return (
                ...
                >
                  <span style={{ marginLeft: "12px" }}>
                    {formatSpanishNumber(rePercentage, 2)}% RE (IVA{" "}
                    {formatSpanishNumber(ivaNum, 2)}%)
                  </span>
