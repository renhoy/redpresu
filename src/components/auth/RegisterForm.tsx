...
import { registerSchema, type RegisterFormData } from '@/lib/validators/auth-schemas'
...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const registerData: RegisterData = {
        ...
        irpfPercentage: formData.tipo === 'autonomo' ? (formData.irpfPercentage ?? 15) : null
      }
      ...
      setErrors({
        general: error instanceof Error ? error.message : 'Error inesperado durante el registro'
      })
    } finally {
      setIsLoading(false)
    }
  ...
  const handleInputChange = (field: keyof RegisterFormData) => (
    ...
    const value = field === 'irpfPercentage'
    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                {errors.nombreComercial && (
                  <p className="text-sm text-red-600">{errors.nombreComercial}</p>
                )}
              </div>
            ...
            {formData.tipo === 'autonomo' && (
              <div className="space-y-2">
                ...
                {errors.irpfPercentage && (
                  <p className="text-sm text-red-600">{errors.irpfPercentage}</p>
                )}
              </div>
            )}
          </div>
          ...
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Datos de Contacto (Opcionales)</h3>
